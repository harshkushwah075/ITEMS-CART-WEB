  ...
  return (
    <>
      <div className="bg-gray-900 rounded-2xl shadow-xl overflow-hidden flex flex-col h-full transition duration-500 transform border-gray-800  group hover:scale-[1.03] hover:shadow-orange-900/40">
        ...
        <button onClick={()=>{AddToCart(product)}} className="flex mx-auto py-3 font-bold w-full  rounded-full shadow-lg shadow-orange-800/50 hover:bg-orange-700 transition duration-300 items-center space-x-2 justify-center transform hover:ring-4 hover:ring-pink-600/40 uppercase tracking-wider bg-orange-600 cursor-pointer">
